...
void harness()
{
     ...
     * is at least allocated to sizeof(ARPPacket_t) size but eventually an even
     * larger buffer. This is not checked inside eARPProcessPacket.
     */
    ...
    /* eARPProcessPacket will be called in the source code only after checking
     * if xNetworkBuffer2.pucEthernetBuffer is not NULL, hence,
     * __CPROVER_assume( xBuffer != NULL );   */
