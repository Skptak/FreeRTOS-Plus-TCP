    ...
    FreeRTOS_Socket_t * const pxSocket )
{
    ...
    __CPROVER_assert( pucPtr != NULL, "prvReadSackOption: pucPtr != NULL" );
    __CPROVER_assert( pxSocket != NULL, "prvReadSackOption: pxSocket != NULL" );
...
void harness()
{
    ...
    /* Postconditions */
    __CPROVER_assert( ( ( index == -1 ) || ( index == 1 ) ||
                        ( index <= uxTotalLength ) ),
